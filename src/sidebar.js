          ...
          <SidebarItem>
            {isLoading ? (
                <Skeleton count={1} width={250} height={150} />
                  ...
                  <>
                  <SidebarLink href="/">
                    <SidebarImg src={sidebarImg} alt="day's playlist"></SidebarImg>
                  </SidebarLink>
                  </>
                )}
          </SidebarItem>
          <SidebarItem>
            {isLoading ? (
                <Skeleton count={1} width={250} height={150} />
                  ...
                  <>
                  <SidebarLink href="/">
                    <SidebarImg src={sidebarImg2} alt="day's playlist"></SidebarImg>
                  </SidebarLink>
                  </>
                )}
          </SidebarItem>
          <SidebarItem>
            {isLoading ? (
                <Skeleton count={1} width={250} height={150} />
                  ...
                  <>
                  <SidebarLink href="/">
                    <SidebarImg src={sidebarImg3} alt="day's playlist"></SidebarImg>
                  </SidebarLink>
                  </>
                )}
          </SidebarItem>
