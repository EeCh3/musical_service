        ...
        <PlaylistTrack>
          <TrackTitle>
            <TrackTitleImage>
              {isLoading ? (
                ...
                <TrackTitleSvg xlinkHref="/musical_service/src/fonts and style/img/icon/sprite.svg#icon-note"></TrackTitleSvg>
              )}
            </TrackTitleImage>
            <div className="track__title-text">
              {isLoading ? (
                ...
                <TrackTitleLink>Guilt<TrackTitleSpan></TrackTitleSpan></TrackTitleLink>
              )}
            </div>
          </TrackTitle>
          <TrackAuthor>
          ...
          {isLoading ? (
            ...
            <div className="track__time">   
              <TrackTimeSvg xlinkHref="/musical_service/src/fonts and style/img/icon/sprite.svg#icon-like"></TrackTimeSvg>
